    ...
    *,
    ...
    base_common = [
        ...
        (
            ...
            _value(corr, latest_live, "tier1_fed_coupon_correction"),
            "included",
            "Fed coupon correction layer.",
        ),
        (
            "interest_cleanup",
            "tier2_bank_coupon_correction",
            _value(corr, latest_live, "tier2_bank_coupon_correction"),
            "included",
            "Bank component-anchored Treasury interest correction layer.",
        ),
        (
            "interest_cleanup",
            "tier2_row_coupon_correction",
            _value(corr, latest_live, "tier2_row_coupon_correction"),
            "included",
            "ROW component-anchored Treasury interest correction layer.",
        ),
    ...
    if not hist.empty:
        ...
        hist_common = [
            ...
            (
                "interest_cleanup",
                "tier1_fed_coupon_correction",
                _value(corr, hist_date, "tier1_fed_coupon_correction"),
                "included",
                "Fed coupon correction layer.",
            ),
            (
                "interest_cleanup",
                "tier2_bank_coupon_correction",
                _value(corr, hist_date, "tier2_bank_coupon_correction"),
                "included",
                "Bank component-anchored Treasury interest correction layer.",
            ),
            (
                "interest_cleanup",
                "tier2_row_coupon_correction",
                _value(corr, hist_date, "tier2_row_coupon_correction"),
                "included",
                "ROW component-anchored Treasury interest correction layer.",
            ),
