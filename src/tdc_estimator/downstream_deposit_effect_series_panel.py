    ...
    *,
    ...
    base_specs = [
        ...
        (
            ...
            False,
            False,
            "Tier 2 corrected headline used for current-quarter downstream deposit-effect work.",
        ),
        (
            "tdc_tier3_fiscal_corrected_bank_only_ru_flow",
            "estimator_series",
            "tier3_partial_shell_diagnostic",
            "partial_fiscal_shell_diagnostic",
            "diagnostic_outlay_only_partial_shell",
            "bank_only",
            False,
            False,
            "Outlay-backed Tier 3 partial shell; receipt cells are missing/not measured, so this is not the headline.",
        ),
        (
            ...
            False,
            False,
            "Broad-depository perimeter comparison around the Tier 3 partial shell.",
        ),
    ]
    for (
        column,
