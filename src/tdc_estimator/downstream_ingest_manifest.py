    ...
    *,
    ...
    rows = [
        ...
        },
        {
            ...
            "binding_boundary": "coupon cleanup terms dominate the live ladder wedge; receipt boundaries dominate current receipt cells",
            "latest_reference_date": latest_series_date,
        ...
        },
        {
            ...
            "consumption_mode": "ingest_early",
            "recommended_for": "understanding which receipt cells are live-zero defaults, historical overlays, bounded pilots, or benchmarks",
